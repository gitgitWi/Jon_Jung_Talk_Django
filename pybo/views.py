...
def comment_modify_question(request, comment_id):
    ...
    context = {'form': form}
    return render(request, 'pybo/commnent_form.html', context)
...
def comment_modify_answer(request, comment_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            comment.modify_date = timezone.now()
            comment.save()
            return redirect('pybo:detail', question_id=comment.answer.questioni.id)
    else:
        form = CommentForm(isinstance=comment)
    context = {'form': form}
    return render(request, 'pybo/comment_form.html', context)
